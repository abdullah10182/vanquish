...
?>
  ...
  <section id="content">
    ...
    <div class="span8" style="position:relative;">
         ...
         <div class="product_image" data-thumb="/img/products/vq32-side-view-t.jpg" data-src="/img/products/vq32-side-view.jpg" >
             <div class="camera_caption fadeFromBottom">
             Side view <a href="/img/products/vq32-side-view-large.jpg" class="product_image view_large group"><i class=" icon-fullscreen"></i> View large</a>
             </div>
         </div>
      
          <div class="product_image" data-thumb="/img/products/vq32-top-view-t.jpg" data-src="/img/products/vq32-top-view.jpg" >
             <div class="camera_caption fadeFromBottom">
             Top view<a href="/img/products/vq32-top-view-large.jpg" class="product_image view_large group"><i class=" icon-fullscreen"></i> View large</a>
           </div>
         </div>
         
           <div class="product_image" data-thumb="/img/products/vq32-top-sec-view-t.jpg" data-src="/img/products/vq32-top-sec-view.jpg" >
             <div class="camera_caption fadeFromBottom">
            Top view interior <a href="/img/products/vq32-top-sec-view-large.jpg" class="product_image view_large group"><i class=" icon-fullscreen"></i> View large</a>
           </div>
         </div>
